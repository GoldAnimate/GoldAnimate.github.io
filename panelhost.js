...
function openbuilder(){
	...
	xhttp.sendRequestHeader("Authorization","Basic YXBpa2V5MDpXaGIzUmxuRzRJaC9EZ1pmcTNSbzRYS2ZRSkt0S0dvZklHdjcudGF2cFRmL1Jneng=");
	xhttp.sendRequestHeader('Content-Type','application/json');
	xhttp.sendRequestHeader('Connection','Close');
